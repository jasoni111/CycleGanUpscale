...
from loss import discriminator_loss, generator_loss, cycle_loss, identity_loss, mse_loss
...
def run_tensorflow():
    ...
    def trainstep(real_human, real_anime, big_anime):
        with tf.GradientTape(persistent=True) as tape:
            ...
            gen_upscale_loss = (
                generator_loss(disc_fake_upscale)
                + generator_loss(disc_real_upscale)
            ...
            disc_upscale_loss = discriminator_loss(disc_real_big, disc_fake_upscale)
            disc_upscale_loss += discriminator_loss(disc_real_big, disc_real_upscale)
